...
library(here)
load(here("submission_3", "results", "hwk3_workspace.RData"))
```
...
#| echo: false
#| label: fig-top5 
#| fig-cap: "Cigarette Sales Per Capita"
#| fig-subcap: "5 States with Highest Increase in Cigarette Prices"
...
#| label: fig-bot5
#| fig-cap: "Cigarette Sales Per Capita"
#| fig-subcap: "5 States with  Lowest Increase in Cigarette Prices"
...
#| echo: false
#| label: fig-compplot 
#| fig-cap: "Comparison of Cigarette Sales" 
#| fig-subcap: "For States with Highest vs. Lowest Increases in Cigarette Prices"
...
The coefficient corresponding to the OLS estimate from this time period (1970-1990) of -0.809 (see table @tab-coef) implies a relatively inelastic demand. Essentially, the quantity cigarettes demanded by consumers is relatively less responsive to changes in price. This observation is logical considering that cigarettes are addictive goods.
...
## 6b.
The coefficient corresponding to the OLS estimate from this time period (1991-2015) of -1 (see table @tab-coef) implies a unitary elasticity of demand. Essentially, for every 1% increase in price, there is an associated 1% decrease in quantity demanded. In comparison to the 1970-1990 period, this relative increase in price elasticity may reflect a growing awareness among consumers about the negative health effects of smoking, making them more responsive to price changes.


## 7b. 
Using an instrumental variable, the coefficient corresponding to the IV estimate from this time period (1991-2015)  is similar but of greater magnitude (-1.000 vs -1.150) than that recovered using OLS (see table @tab-coef). This difference suggests that the OLS estimate may have underestimated price elasticity due to endogeneity. By using the tax as an instrument, the IV regression addresses potential issues like reverse causality and omitted variable bias, which may have caused the OLS estimate to be biased toward zero. IV isolates the exogenous variation in price, which can give a more accurate estimate of the elasticity.
